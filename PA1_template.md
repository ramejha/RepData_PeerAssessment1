...
Now we can check if there are any missing values remaining or not:
...
It seems that the impact of imputing missing values has increase our peak, but it has not affected negatively on our predictions. 
